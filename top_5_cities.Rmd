...
plot_cause1 = plot_cause %>% 
  ...
  ggplot(aes(fill = cause, x = city, y = freq)) + geom_bar(position = "dodge", stat = "identity") + labs(x = "City", y = "Frequency", title = "Cause of Death by Police Weapon", caption = "Jan-Jun 2015") + scale_fill_brewer(palette = "Set2") 
...
plot_armed1 = plot_armed %>% 
  ...
  ggplot(aes(fill = armed, x = city, y = freq)) + geom_bar(position = "dodge", stat = "identity") + labs(x = "City", y = "Frequency", title = "Victim Armed with a Weapon", caption = "Jan - Jun 2015") + scale_fill_brewer(palette = "Set2") 
